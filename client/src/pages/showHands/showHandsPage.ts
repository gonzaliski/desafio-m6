...
customElements.define('show-hands-page', class ShowHandsPage extends HTMLElement {
   playerMove = state.getPlayerSelection();
   comMove = state.getComSelection();
   imageURL = require("url:../../assets/star.png");
  connectedCallback(){
    this.render()
  }
  addListeners(){
    this.querySelector(".play-again__button")
  ...
  render(){
    this.innerHTML = `
      ...
      <elemento-el elemento="${this.comMove}" class="option-com"></elemento-el>
